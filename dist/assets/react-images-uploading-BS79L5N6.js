import { c as commonjsGlobal } from "./@floating-ui-4Y5N-uvO.js";
...
constants.DEFAULT_DATA_URL_KEY = constants.INIT_MAX_NUMBER = constants.DEFAULT_NULL_INDEX = void 0;
constants.DEFAULT_NULL_INDEX = -1;
constants.INIT_MAX_NUMBER = 1e3;
constants.DEFAULT_DATA_URL_KEY = "dataURL";
(function(exports) {
  ...
  exports.isMaxNumberValid = function(totalNumber, maxNumber, keyUpdate) {
    if (maxNumber !== 0 && !maxNumber)
      return true;
    if (keyUpdate === constants_12.DEFAULT_NULL_INDEX) {
      ...
      return __generator2(this, function(_b) {
        switch (_b.label) {
          ...
          case 2:
            ...
            return [4, utils_12.getImage(file)];
          case 3:
            image = _b.sent();
...
var _default = dist.default = ReactImageUploading;
export {
  _default as _
};
