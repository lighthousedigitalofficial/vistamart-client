...
popmotion_cjs.cubicBezier = cubicBezier;
...
popmotion_cjs.interpolate = interpolate;
...
popmotion_cjs.progress = progress;
...
popmotion_cjs.spring = spring;
popmotion_cjs.steps = steps;
popmotion_cjs.toDecimal = toDecimal;
popmotion_cjs.velocityPerFrame = velocityPerFrame;
popmotion_cjs.velocityPerSecond = velocityPerSecond;
popmotion_cjs.wrap = wrap;
export {
  popmotion_cjs as p
};
